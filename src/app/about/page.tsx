        ...
        <div className="text-center mt-12">
            ...
            >
              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-background dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                <Rocket className="mr-2 h-5 w-5 inline-block transition-transform duration-500 ease-out group-hover:-translate-y-1 group-hover:translate-x-1" />
                Meet the Creator
              </span>
            </Button>
        </div>
